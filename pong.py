...
class Ball(Block):
	...
	def restart_counter(self):
		...
		if current_time - self.score_time <= 1500:
			countdown_number = 3
		if 1500 < current_time - self.score_time <= 2500:
			countdown_number = 2
		if 2500 < current_time - self.score_time <= 3500:
			countdown_number = 1
...
# Game objects
player_speed = 5
player = Player('Paddleblue.png',screen_width - 20,screen_height/2,player_speed)
opponent_speed = 5
opponent = Opponent('Paddlered.png',20,screen_width/2,opponent_speed)
...
while True:
	...
	pygame.draw.rect(screen,'#f0f0f0',middle_strip)
